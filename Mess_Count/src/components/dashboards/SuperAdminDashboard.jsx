...
function SuperAdminDashboard() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center">
        <UserPlus className="mr-2 h-8 w-8 text-purple-500" /> Create New Admin
      </h2>
  ...
  //         <div className="max-w-4xl mx-auto">
  //           <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center">
  //             <Users className="mr-2 h-8 w-8 text-purple-500" /> Promote to Admin
  //           </h2>
  //           <div className="bg-white rounded-xl shadow-lg p-6">
  //             <div className="mb-6">
  //               <input
  ...
  //         <div className="max-w-4xl mx-auto">
  //           <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center">
  //             <ChefHat className="mr-2 h-8 w-8 text-purple-500" /> Add Mess Staff
  //           </h2>
  //           <div className="bg-white rounded-xl shadow-lg p-6">
  //             <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
  //               <div>
  ...
  //         <div className="max-w-4xl mx-auto">
  //           <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center">
  //             <BarChart3 className="mr-2 h-8 w-8 text-purple-500" /> All Food
  //             Counts
  //           </h2>
  //           <div className="bg-white rounded-xl shadow-lg p-6">
  ...
  //               <p className="text-gray-500">Comprehensive Chart Placeholder</p>
  //             </div>
  //           </div>
  //         </div>
  //       );
