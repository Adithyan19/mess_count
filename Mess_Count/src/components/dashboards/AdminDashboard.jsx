  ...
  switch (activeRoute) {
      ...
      content = (
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center">
            <BarChart3 className="mr-2 h-8 w-8 text-blue-500" /> Food Count
            Analytics
          </h2>
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-blue-50 p-4 rounded-lg text-center">
                ...
                <p className="text-gray-600">Breakfast Served</p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg text-center">
              ...
              <div className="bg-blue-50 p-4 rounded-lg text-center">
                <p className="text-3xl font-bold text-blue-700">180</p>
    ...
    case "/food-taken":
      content = (
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center">
            <UtensilsCrossed className="mr-2 h-8 w-8 text-blue-500" /> Food
            Taken Records
          </h2>
    ...
    case "/add-student":
      content = (
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center">
            <UserPlus className="mr-2 h-8 w-8 text-blue-500" /> Add New Student
          </h2>
          <div className="bg-white rounded-xl shadow-lg p-6">
    ...
    case "/student-logs":
      content = (
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center">
            <Clock className="mr-2 h-8 w-8 text-blue-500" /> Student Activity
            Logs
          </h2>
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <table className="w-full">
